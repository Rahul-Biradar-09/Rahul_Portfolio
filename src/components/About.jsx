  ...
  return (
    ...
    >
      <div className="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 py-20">
        <div className="bg-white/80 backdrop-blur-lg p-6 sm:p-8 md:p-12 lg:p-14 rounded-3xl shadow-2xl max-w-xl sm:max-w-2xl lg:max-w-3xl w-full text-center text-gray-900">
          ...
          <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-700 leading-relaxed">
            I'm a Full Stack Developer specializing in the <strong>MERN stack</strong>. I build responsive, scalable, and user-friendly web applications with a strong focus on performance, clean code, and seamless user experiences. Passionate about building modern solutions that solve real-world problems through technology.
          </p>
        </div>
      </div>
    </section>
