  ...
  return (
    ...
    >
      <div className="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 py-20">
        <div className="bg-white/80 mt-16 backdrop-blur-lg p-6 sm:p-8 md:p-12 lg:p-14 rounded-3xl shadow-2xl max-w-xl sm:max-w-2xl lg:max-w-3xl w-full text-center text-gray-900">
